VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} fTiposObra 
   Caption         =   ":: Cadastro de Tipos de Obra ::"
   ClientHeight    =   7800
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   9120
   OleObjectBlob   =   "fTiposObra.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "fTiposObra"
...
Private Const sTable As String = "tbl_tipos_obra"
...
'                With lstPrincipal
'                    .AddItem
'                    .List(.ListCount - 1, 0) = oTipoObra.NomeFantasia
'                    .List(.ListCount - 1, 1) = oTipoObra.ID
'                    .List(.ListCount - 1, 2) = oTipoObra.Endereco
'                End With
...
'                With lstPrincipal
'                    .List(.ListIndex, 0) = oTipoObra.NomeFantasia
'                    .List(.ListIndex, 2) = oTipoObra.Endereco
'                End With
...
Private Sub lstPrincipalPopular(OrderBy As String)
    ...
    Set col = oTipoObra.Listar(OrderBy)
