...
'                With lstPrincipal
'                    .AddItem
'                    .List(.ListCount - 1, 0) = oCliente.NomeFantasia
'                    .List(.ListCount - 1, 1) = oCliente.ID
'                    .List(.ListCount - 1, 2) = oCliente.Endereco
'                End With
...
'                With lstPrincipal
'                    .List(.ListIndex, 0) = oCliente.NomeFantasia
'                    .List(.ListIndex, 2) = oCliente.Endereco
'                End With
...
Private Sub lstPrincipal_Change()
    ...
    If bListBoxOrdenando = False Then
        ...
        If lstPrincipal.ListIndex >= 0 Then
            oCliente.Carrega (CLng(lstPrincipal.List(lstPrincipal.ListIndex, 1)))
        End If
        
        lblID.Caption = Format(IIf(oCliente.Id = 0, "", oCliente.Id), "00000")
        lblCabNome.Caption = oCliente.Nome
        txbNome.Text = oCliente.Nome
...
Private Sub lstPrincipalPopular(OrderBy As String)
    ...
    Set col = oCliente.Listar(OrderBy)
