...
Private Function Valida() As Boolean
    ...
    If txbNome.Text = Empty Then
        MsgBox "'Nome' é um campo obrigatório", vbInformation: MultiPage1.Page = 1: txbNome.SetFocus
    ElseIf txbSaldoInicial.Text = Empty Then
        MsgBox "'Saldo inicial' é um campo obrigatório", vbInformation: MultiPage1.Page = 1: txbSaldoInicial.SetFocus
    Else
